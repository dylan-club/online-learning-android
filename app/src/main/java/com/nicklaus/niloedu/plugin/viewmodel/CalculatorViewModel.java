package com.nicklaus.niloedu.plugin.viewmodel;
...
public class CalculatorViewModel extends AndroidViewModel {
    ...
    private static final String KEY_SAVE_SHP_DATA_NAME = "save_shp_data_name";
    ...
    public CalculatorViewModel(@NonNull Application application, SavedStateHandle handle) {
        super(application);
        if (!handle.contains(KEY_HIGH_SCORE)) {
            SharedPreferences shp = getApplication().getSharedPreferences(KEY_SAVE_SHP_DATA_NAME,
